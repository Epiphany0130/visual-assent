package com.guyuqi.backend.manager.auth;
...
import static com.guyuqi.backend.constant.UserConstant.USER_LOGIN_STATE;
...
public class StpInterfaceImpl implements StpInterface {
    ...
    /**
     * 本项目中不用 返回一个账号所拥有的角色标识集合 (权限与角色可分开校验)
     */
    @Override
    ...
    private SpaceUserAuthContext getAuthContextByRequest() {
        ...
        if (ContentType.JSON.getValue().equals(contentType)) {
            ...
            originalMap.forEach((k, v) -> paramMap.put(k, v.length > 0 ? v[0] : ""));
